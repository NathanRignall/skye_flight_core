...
package Hardware is
    ...
    Servo1 : Drivers.Servo.Servo (Control_Point => Skye_Flight.SERVO1'Access);
    Servo2 : Drivers.Servo.Servo (Control_Point => Skye_Flight.SERVO2'Access);
    Servo3 : Drivers.Servo.Servo (Control_Point => Skye_Flight.SERVO3'Access);
    Servo4 : Drivers.Servo.Servo (Control_Point => Skye_Flight.SERVO4'Access);
